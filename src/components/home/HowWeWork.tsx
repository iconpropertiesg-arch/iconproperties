...
export default function HowWeWork({ locale }: HowWeWorkProps) {
  ...
  return (
    <section className="relative bg-black py-12 sm:py-20">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <h2 ref={titleRef} style={titleBlurStyle} className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 px-4">
              {(() => {
                const titleText = "The Private Buying Experience";
                const titleLines = titleText.split('\n').map(line => line.trim()).filter(line => line.length > 0);
                const finalTitleLines = titleLines.length > 0 ? titleLines : [titleText.trim()];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            {/* Left Side - Image */}
            <div className="relative lg:sticky lg:top-20 w-full">
              <div className="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl w-full">
              ...
              {steps.map((step, index) => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      "relative rounded-2xl border border-white/20 p-5 sm:p-6 transition-all duration-700 ease-out overflow-hidden w-full",
                      isVisible
                        ? "opacity-100 translate-y-0"
